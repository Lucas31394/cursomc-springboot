package com.springrest.cursospringrest.resources.exceptions;
...
import com.springrest.cursospringrest.services.exceptions.FileException;
...
public class ResourceExceptionHandler {
	...
	public ResponseEntity<StandardError> authorization(AuthorizationException e, HttpServletRequest request) {
		...
		StandardError err = new StandardError(System.currentTimeMillis(), HttpStatus.FORBIDDEN.value(), "Forbidden accsess", e.getMessage(), request.getRequestURI());
